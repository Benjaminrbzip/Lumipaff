...
class PodInfo {
  int state = 0; // 0: OFF, 1: GREEN, 2: ORANGE
  Timer? greenTimer;
  Timer? orangeTimer;
...
class _LumiTaupeGamePageState extends State<LumiTaupeGamePage> {
  ...
  void _spawnRandomMole() {
    ...
    if (inactiveIndices.isEmpty) return; // Toutes les taupes sont déjà sorties !
                    ...
                    child: AspectRatio(
                      ...
                      child: GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          Color podColor = Colors.redAccent.withOpacity(0.3);
                          if (isActive) {
                            podColor = _pods[index].state == 1 ? Colors.greenAccent : Colors.orangeAccent;
                          }
                          
                          return GestureDetector(
                            onTap: () => _onBuzzerTap(index),
